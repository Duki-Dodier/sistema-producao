...
const NAV_ITEMS = [
  ...
  { href: "/pcp/plano-corte-tubos", label: "Plano de Corte — Tubos", icon: TubeCutIcon },
...
function TubeCutIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M4 7h16v5H4z" />
      <path d="m8 7 2.5 5M14 7l2.5 5" />
      <path d="M7 17h10M12 14v6" />
    </svg>
  );
}
