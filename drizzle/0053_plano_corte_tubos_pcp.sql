-- Substitui o fluxo antigo, que reservava sobras e permitia conclusão pelo
-- operador, por documentos orientativos emitidos exclusivamente pelo PCP.
-- As quatro tabelas antigas estavam vazias antes desta migração.
...
CREATE TABLE "PlanoCorteTubo" (
  ...
  CONSTRAINT "PlanoCorteTubo_criadoPorId_fkey"
...
CREATE TABLE "PlanoCorteTuboPadrao" (
  ...
  CONSTRAINT "PlanoCorteTuboPadrao_planoId_fkey"
...
CREATE TABLE "PlanoCorteTuboItem" (
  ...
  CONSTRAINT "PlanoCorteTuboItem_padraoId_fkey"
    FOREIGN KEY ("padraoId") REFERENCES "PlanoCorteTuboPadrao" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT "PlanoCorteTuboItem_opId_fkey"
    FOREIGN KEY ("opId") REFERENCES "OP" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT "PlanoCorteTuboItem_pecaId_fkey"
    FOREIGN KEY ("pecaId") REFERENCES "Peca" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
