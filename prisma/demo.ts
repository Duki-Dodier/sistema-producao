...
const nomesPorSetor: Record<string, string[]> = {
  ...
  ABASTECIMENTO: ["ANA", "BRUNA", "LUCAS", "PAULO"],
...
const modelos: ModeloDemo[] = [
  {
    ...
    quantidadeOP: 30,
    sequencia: 10,
    roteiro: ["TUBO", "PLASMA CHAPA", "COMPONENTES E ACESSÓRIOS", "PONTEIRA", "ABASTECIMENTO", "SOLDA", "PINTURA", "MONTAGEM"],
    pecas: [
  ...
  },
  {
    ...
    quantidadeOP: 20,
    sequencia: 20,
    roteiro: ["PLASMA TUBO", "COMPONENTES E ACESSÓRIOS", "PONTEIRA", "ABASTECIMENTO", "SOLDA", "PINTURA", "MONTAGEM"],
    pecas: [
  ...
  },
  {
    ...
    quantidadeOP: 15,
    sequencia: 30,
    roteiro: ["TUBO", "PLASMA CHAPA", "ABASTECIMENTO", "SOLDA", "PINTURA", "MONTAGEM"],
    pecas: [
